...
export const TutorialProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const startTutorial = (type: 'general' | 'specific' = 'general') => {
    ...
    if (type === 'specific') {
        if (pathname === '/inventario') steps = inventorySteps;
        else if (pathname === '/cart') steps = cartSteps;
        else if (pathname === '/debtors') steps = debtorsSteps;
        else if (pathname === '/sales') steps = salesSteps;
        else if (pathname === '/expenses') steps = expensesSteps;
